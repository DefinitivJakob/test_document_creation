...
- [docs/lighthouse-monitoring.md](docs/lighthouse-monitoring.md) — Kunden-Anleitung: Monitoring-Zugriff (Application Insights) für unit-ix read-only freigeben (Azure Lighthouse)
